...
IJK_FFMPEG_UPSTREAM=https://gitee.com/mirrors_bilibili/FFmpeg.git
IJK_FFMPEG_FORK=https://gitee.com/mirrors_bilibili/FFmpeg.git
IJK_FFMPEG_COMMIT=ff3.4--ijk0.8.7--20180103--001
IJK_FFMPEG_LOCAL_REPO=extra/ffmpeg

IJK_GASP_UPSTREAM=https://gitee.com/mirrors_bilibili/gas-preprocessor.git
